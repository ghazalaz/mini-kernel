...
void initialise_paging(size_t memsz)
{
    ...
    /*heap_t* tmp = create_heap(KHEAP_START+KHEAP_INITIAL_SIZE, KHEAP_START+KHEAP_INITIAL_SIZE+KHEAP_INITIAL_SIZE, 0xCFFFF000, 0, 0);
    monitor_write("start\n");
    monitor_write_hex(tmp->start_address);
    monitor_write("end\n");*/
