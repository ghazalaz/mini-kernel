...
static struct dirent *initrd_readdir(fs_node_t *node, int index)
{
...
fs_node_t *initialise_initrd(uint32_t location)
{
    ...
    initrd_root->open = 0;
    initrd_root->close = 0;
    initrd_root->readdir = (readdir_type_t)&initrd_readdir;
    ...
    initrd_dev->open = 0;
    initrd_dev->close = 0;
    initrd_dev->readdir = (readdir_type_t)&initrd_readdir;
    initrd_dev->finddir = (finddir_type_t)&initrd_finddir;
    initrd_dev->ptr = 0;
    initrd_dev->impl = 0;
